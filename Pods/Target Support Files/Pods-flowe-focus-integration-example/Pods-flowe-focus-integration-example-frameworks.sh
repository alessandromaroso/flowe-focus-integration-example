...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/Contentful/Contentful.framework"
  install_dsym "${PODS_ROOT}/Contentful/Contentful.framework.dSYM"
  install_framework "${PODS_ROOT}/URLImage/URLImage.framework"
  install_dsym "${PODS_ROOT}/URLImage/URLImage.framework.dSYM"
  install_framework "${PODS_ROOT}/flowe-focus-ios/flowe_focus_ios.framework"
  install_dsym "${PODS_ROOT}/flowe-focus-ios/flowe_focus_ios.framework.dSYM"
fi
